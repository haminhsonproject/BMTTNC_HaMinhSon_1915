...
def caesar_encrypt():
    ...
    return f"<h3>Caesar - Encrypt</h3>text: {text}<br/>key: {key}<br/>encrypted text: <b>{encrypted_text}</b><br/><br/><a href='/caesar'>← Back</a>"
...
def caesar_decrypt():
    ...
    return f"<h3>Caesar - Decrypt</h3>text: {text}<br/>key: {key}<br/>decrypted text: <b>{decrypted_text}</b><br/><br/><a href='/caesar'>← Back</a>"
