...
def playfaircreatematrix():
    data = request.json
    key = data["Key"]
    playfairmatrix = playfair_cipher.create_playfair_matrix(key)
    return jsonify({"playfairmatrix": playfairmatrix})
...
def playfair_encrypt():
    ...
    key = data['Key']
    playfairmatrix = playfair_cipher.create_playfair_matrix(key)
    encrypted_text = playfair_cipher.playfair_encrypt(plain_text, playfairmatrix)
    return jsonify({'encrypted_message': encrypted_text})
...
def playfair_decrypt():
    ...
    key = data['Key']
    playfairmatrix = playfair_cipher.create_playfair_matrix(key)
    decrypt_text = playfair_cipher.playfair_decrypt(cipher_text, playfairmatrix)
